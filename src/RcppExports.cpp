...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(rcpp_main(Sizes, pdf_binned_z_list_index0, pdf_binned_z_list_index1, pdf_binned_z_list_index2, binned_z_mat_list, cluster_ind_list, repfdr_Pi_list));
    return __result;
END_RCPP
}
