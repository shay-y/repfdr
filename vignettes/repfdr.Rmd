...
author: "Barak Brill, Ruth Heller, Shay Yaacobi, Daniel Yekutieli"
date: "2017 - 07 - 17"
output: pdf_document
toc: TRUE
vignette: |
...
```{r,eval = TRUE, fig.width=6, fig.height=4, fig.align='center',echo=T}
...
load('plot_ldr.Rdata')
knitr::kable(plot_ldr,format = "latex")
